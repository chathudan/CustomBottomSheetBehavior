...
public class BottomSheetBehaviorGoogleMapsLike<V extends View> extends ScrollTrackingBehavior<V> {
    ...
    public void onStopNestedScroll( CoordinatorLayout coordinatorLayout, V child, View target ) {
        ...
        Log.e("e","scroll velocity=" + scrollVelocity + " min=" + mMinimumVelocity);

        if ( scrollVelocity > mMinimumVelocity) {
            Log.e("e","FLINGING UP" );
            if ( mLastStableState == STATE_COLLAPSED ) {
                Log.e("e","FLINGING TO ANCHOR" );
            ...
            if ( mLastStableState == STATE_ANCHOR_POINT ) {
                Log.e("e","Flinging to expanded");
                // Fling from anchor to expanded
                top = mMinOffset;
                targetState = STATE_EXPANDED;
            }
            else {
                Log.e("e","Already expanded");
